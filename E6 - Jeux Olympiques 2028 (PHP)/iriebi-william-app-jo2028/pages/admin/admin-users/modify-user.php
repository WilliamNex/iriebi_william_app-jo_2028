...
<body>
    ...
    <main>
        ...
        <form action="modify-user.php?id_admin=<?php echo $id_admin; ?>" method="post"
            ...
            <input type="text" name="nomAdmin" id="nomAdmin" value="<?php echo htmlspecialchars($utilisateur['nom_admin']); ?>" required>

            <label for="prenomAdmin">Prénom de l'utilisateur :</label>
            <input type="text" name="prenomAdmin" id="prenomAdmin" value="<?php echo htmlspecialchars($utilisateur['prenom_admin']); ?>" required>

            <label for="login">Login :</label>
            <input type="text" name="login" id="login" value="<?php echo htmlspecialchars($utilisateur['login']); ?>" required>
